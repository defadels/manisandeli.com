<div class="card">
    <div class="card-body">
        <h5 class="mb-0 text-primary font-weight-bold">45.5 GB <span class="float-right text-secondary">50 GB</span></h5>
        <p class="mb-0 mt-2"><span class="text-secondary">Used</span><span class="float-right text-primary">Upgrade</span>
        </p>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-3">
                ...
                <div class="card shadow-none bg-primary">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="fm-icon-box"><i class='lni lni-google-drive'></i>
                            </div>
                            <div class="ml-auto font-24 text-white"><i class='bx bx-dots-horizontal-rounded'></i>
                            </div>
                        </div>
                        <h5 class="mt-3 mb-0 text-white">Google Drive</h5>
                        <p class="mb-1 mt-4 text-white"><span>45.5 GB</span>  <span class="float-right">50 GB</span>
                        </p>
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-none bg-danger">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="fm-icon-box"><i class='lni lni-dropbox-original'></i>
                            </div>
                            <div class="ml-auto font-24 text-white"><i class='bx bx-dots-horizontal-rounded'></i>
                            </div>
                        </div>
                        <h5 class="mt-3 mb-0 text-white">Dropbox</h5>
                        <p class="mb-1 mt-4 text-white"><span>1,2 GB</span>  <span class="float-right">3 GB</span>
                        </p>
                        <div class="progress" style="height: 7px;">
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-none bg-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="fm-icon-box"><i class='bx bxs-door-open'></i>
                            </div>
                            <div class="ml-auto font-24"><i class='bx bx-dots-horizontal-rounded'></i>
                            </div>
                        </div>
                        <h5 class="mt-3 mb-0">OneDrive</h5>
                        <p class="mb-1 mt-4"><span>2,5 GB</span>  <span class="float-right">3 GB</span>
                        </p>
                        <div class="progress" style="height: 7px;">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ml-auto"><a href="javascript:;" class="btn btn-sm btn-outline-secondary">View all</a>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover table-sm mb-0">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div><i class='bx bxs-file-pdf mr-2 font-24 text-danger'></i>
                                </div>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div><i class='bx bxs-file mr-2 font-24 text-primary'></i>
                                </div>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div><i class='bx bxs-file-doc mr-2 font-24 text-success'></i>
                                </div>
