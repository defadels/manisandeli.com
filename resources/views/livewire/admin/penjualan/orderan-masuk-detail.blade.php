    ...
    <div class="card radius-15">
        ...
        <div class="card-body">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                       @foreach($orderan->order_item as $item) 
                        <tr>
                            <th scope="row"><img src="{{ $item->item->foto_produk }}" class="img-thumbnail" style="width:150px;" alt=""></th>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p>{{number_format($orderan->subtotal)}}</p>
                </div>
                <div class="col-lg-6">
                    <p>Ongkos Kirim</p>
                </div>
                <div class="col-lg-6">
                    <p>{{number_format($orderan->ongkir)}}</p>
                </div>
                <div class="col-lg-6">
                    <p>Total</p>
                </div>
                <div class="col-lg-6">
                    <p>{{number_format($orderan->total)}}</p>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <form wire:submit.prevent="konfirmasiOrderan">
                    ...
                    <button type="submit" class="btn btn-sm btn-success ml-3">Konfirmasi</button>
                </form>
            </div>
