                ...
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-toggle="dropdown">
                    <div class="media user-box align-items-center">
                        <div class="media-body user-info">
                            ...
                            <p class="designattion mb-0">{{ucfirst(Auth::user()->roles)}}</p>
                        </div>
                        <img src="@if(Auth::user()->foto_profil)  {{ Storage::url(Auth::user()->foto_profil) }} @else https://via.placeholder.com/110x110 @endif" class="user-img" alt="{{Auth::user()->nama}}">
                    </div>
                </a>
