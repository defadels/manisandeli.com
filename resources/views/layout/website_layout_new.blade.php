...
<html lang="en">
    ...
    <body>
        ...
        =======================================-->
        <section class="news-part" style="background: url(frontend/images/newsletter.jpg) no-repeat center;">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="footer-widget">
                            ...
                            <div class="footer-app">
                                <a href="#"><img src="frontend/images/google-store.png" alt="google"></a>
                                <a href="#"><img src="frontend/images/app-store.png" alt="app"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        =======================================-->
        <!-- VENDOR -->
        <script src="frontend/vendor/bootstrap/jquery-1.12.4.min.js"></script>
        <script src="frontend/vendor/bootstrap/popper.min.js"></script>
        <script src="frontend/vendor/bootstrap/bootstrap.min.js"></script>
        <script src="frontend/vendor/countdown/countdown.min.js"></script>
        <script src="frontend/vendor/niceselect/nice-select.min.js"></script>
        <script src="frontend/vendor/slickslider/slick.min.js"></script>
        <script src="{{asset('frontend/vendor/venobox/venobox.min.js')}}"></script>

        <!-- CUSTOM -->
        <script src="frontend/js/nice-select.js"></script>
        <script src="frontend/js/countdown.js"></script>
        <script src="frontend/js/accordion.js"></script>
        <script src="frontend/js/venobox.js"></script>
