                    ...
                    <div class="cart-info-group">
                        ...
                        <div class="cart-action-group">
                            <div class="product-action">
                                <button class="action-minus" min="0" title="Quantity Minus"><i class="icofont-minus"></i></button>
                                <input class="action-input" title="Quantity Number" type="text" pattern="[0-9]*" name="qty" value="{{$item->qty}}">
                                <button class="action-plus" max="120" title="Quantity Plus"><i class="icofont-plus"></i></button>
                            </div>
