...
class CheckoutTransferAlamat extends Component
{
   ...
   public function showData($alamat_detail){
    ...
    public function render()
    {
        ...
        return view('livewire.website.checkout-transfer-alamat',compact('daftar_alamat','daftar_bank_pelanggan','daftar_bank_toko'))->layout('layout.website_layout');
    }
